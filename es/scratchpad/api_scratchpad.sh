curl -X POST "localhost:9200/reddit-crypto-custom/_count?pretty" -H 'Content-Type: application/json' -d'
{
        "query": {
            "bool": {
                "must": [
...
curl -X PUT "localhost:9200/reddit-crypto-custom/_settings?pretty"

curl -X POST "localhost:9200/reddit-crypto-custom/_analyze?pretty" -H 'Content-Type: application/json' -d '
{
  "analyzer": "standard",
...
curl -X PUT "localhost:9200/test-custom-analyzer?pretty" -H "Content-Type: application/json" -d '
{
  "settings": {
    "analysis": {
    "analyzer": {
