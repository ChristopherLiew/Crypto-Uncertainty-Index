...
# C++ class DFGLS<double> exposed to R
DFGLS_d <- R6Class("DFGLS_d",
  private = list(
    ptr = NULL
  ),
  public = list(
    initialize = function(data = NA, lags = "", method = "AIC", trend = "c", regression = FALSE) {
      if (lags == "") {
        private$ptr <- .Call('DFGLS_d__new2', PACKAGE = 'RcppURT', data_ = data, method_ = method, trend_ = trend, regression_ = regression)
      } else {
        private$ptr <- .Call('DFGLS_d__new1', PACKAGE = 'RcppURT', data_ = data, lags_ = lags, trend_ = trend, regression_ = regression)
      }
    },
    statistic = function() {
...
# C++ class DFGLS<float> exposed to R
DFGLS_f <- R6Class("DFGLS_f",
  private = list(
    ptr = NULL
  ),
  public = list(
    initialize = function(data = NA, lags = "", method = "AIC", trend = "c", regression = FALSE) {
      if (lags == "") {
        private$ptr <- .Call('DFGLS_f__new2', PACKAGE = 'RcppURT', data_ = data, method_ = method, trend_ = trend, regression_ = regression)
      } else {
        private$ptr <- .Call('DFGLS_f__new1', PACKAGE = 'RcppURT', data_ = data, lags_ = lags, trend_ = trend, regression_ = regression)
      }
    },
    statistic = function() {
